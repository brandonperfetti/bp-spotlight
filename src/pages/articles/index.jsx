...
export default function ArticlesIndex({ articles }) {
  return (
    <>
      <Head>
        <title>Articles - Brandon Perfetti</title>
        <meta
          name="description"
          content="All of my long-form thoughts on mindset,programming, leadership, product design, and more, collected in chronological order."
        />
      </Head>
      <SimpleLayout
